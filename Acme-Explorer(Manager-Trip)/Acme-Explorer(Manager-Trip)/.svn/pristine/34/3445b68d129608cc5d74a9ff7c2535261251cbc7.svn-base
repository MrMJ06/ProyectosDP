...
<form:form id = "form" action = "curriculum/ranger/edit.do" modelAttribute = "curriculum">
	...
	<form:input path = "personalRecord.photo" placeholder="http://www.photoexample.com" />
	...
	<form:input path = "personalRecord.email" placeholder="example@email.dominio" />
	...
	<form:input path = "personalRecord.linkedInProfileURL" placeholder="http://www.example.com"/>
	...
	<a href = "curriculum/ranger/list.do">
		<input type = "button" class = "btn" name = "cancel" value = "<spring:message code = "curriculum.cancel" />" >
	</a>
