...
public class TripService {
	...
	public Trip create() {
		...
		final Collection<Alert> alerts = new HashSet<Alert>();
	...
	public Collection<Alert> findPublicatedAlertsFromTrip(final int tripId) {
		Assert.isTrue(tripId != 0);

		Collection<Alert> result;

		result = this.tripRepository.findPublicatedAlertsFromTrip(tripId);
