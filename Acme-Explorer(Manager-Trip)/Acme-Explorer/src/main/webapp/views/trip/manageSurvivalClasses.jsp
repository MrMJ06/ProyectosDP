...
<form action="trip/manager/manageSurvivalClasses.do" method="POST">
	<input type="hidden" name="tripId" value="${trip}"> <select
		name="selectedSurvivalClasses" multiple>
	...
	</select> <input type="submit" name="save" class="btn"
		value="<spring:message code="trip.save" />"> <input
