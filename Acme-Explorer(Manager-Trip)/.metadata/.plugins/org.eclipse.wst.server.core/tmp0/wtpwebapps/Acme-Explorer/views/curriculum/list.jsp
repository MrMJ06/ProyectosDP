...
<jstl:if test="${curriculum != null}">
	...
	<security:authorize access="hasRole('RANGER')">
		<jstl:if test="${isProfile}">
			<a
				href="personalRecord/ranger/edit.do?personalRecordId=${personalRecord.id}">
				<button class="btn">
	...
	<jstl:if test="${not empty curriculum.professionalRecords}">
		<h2>
			<spring:message code="curriculum.professionalRecords" />
		</h2>
		...
		<display:table name="professionalRecords" id="professionalRecord"
			...
			<security:authorize access="hasRole('RANGER')">7
				<jstl:if test="${isProfile}">
					<display:column>
						<a
	...
	<jstl:if test="${not empty miscellaneousRecords}">
		<h2>
			<spring:message code="curriculum.miscellaneousRecords" />
		</h2>
	...
	<jstl:if test="${not empty curriculum.educationRecords}">
		<security:authorize access="hasRole('RANGER')">
			<h2>
				<spring:message code="curriculum.educationRecords" />
			</h2>
	...
	<jstl:if test="${not empty curriculum.endorserRecords}">
		<h2>
			<spring:message code="curriculum.endorserRecords" />
		</h2>
...
<security:authorize access="hasRole('RANGER')">
	<jstl:if
		test="${curriculum==null && isProfile && curriculumRanger==null}">
...
<security:authorize access="hasRole('RANGER')">
	<jstl:if test="${curriculum!=null&&isProfile&&curriculumRanger==null}">
