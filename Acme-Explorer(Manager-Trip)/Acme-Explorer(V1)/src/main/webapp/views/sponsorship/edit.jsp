...
<form:form action = "sponsorship/sponsor/edit.do" modelAttribute = "sponsorship">
	...
	<form:label path = "creditCard.holderName">
		...
		oninvalid="setCustomValidity('${inputError}')"
    	onchange="try{setCustomValidity('')}catch(e){}" placeholder = "XXXXXXXXXXXXXXXXX"/>
		...
		oninvalid="setCustomValidity('${inputError}')"
    	onchange="try{setCustomValidity('')}catch(e){}" placeholder = "XX"/>
		...
		oninvalid="setCustomValidity('${inputError}')"
    	onchange="try{setCustomValidity('')}catch(e){}" placeholder = "XXX"/>
		<form:errors cssClass = "error" path = "creditCard.cvv"/>
		<br />
	</jstl:if>
	
	
	<input type = "submit" name = "save" class = "btn" value = "<spring:message code = "sponsorship.save"/>" />
	<jstl:if test="${sponsorship.id!=0}">
		<input 
			type="submit"
			name="delete"
