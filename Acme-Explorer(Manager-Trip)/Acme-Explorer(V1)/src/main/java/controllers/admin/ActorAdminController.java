...
public class ActorAdminController extends AbstractController {
	...
	//Saving manager ---------------------------------------------------------------------
	@RequestMapping(value = "/register-manager", method = RequestMethod.POST, params = {
		"save", "confirmPassword"
	})
	public ModelAndView registerManagerSave(@ModelAttribute("actor") @Valid final Manager actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
		...
		if (binding.hasErrors())
			...
			try {
				...
				if (oops.getMessage().contains("Passwords do not match"))
					result = this.createEditModelAndViewRegister(actor, "actor.params.confirm.error");
				else
	...
	public ModelAndView registerAdminSave(@ModelAttribute("actor") @Valid final Administrator actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
	...
	//Saving auditor ---------------------------------------------------------------------
	@RequestMapping(value = "/register-auditor", method = RequestMethod.POST, params = {
		"save", "confirmPassword"
	})
	public ModelAndView registerAuditorSave(@ModelAttribute("actor") @Valid final Auditor actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
	...
	public ModelAndView registerSponsorSave(@ModelAttribute("actor") @Valid final Sponsor actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
	...
	//Saving ranger ---------------------------------------------------------------------
	@RequestMapping(value = "/register-ranger", method = RequestMethod.POST, params = {
		"save", "confirmPassword"
	})
	public ModelAndView registerRangerSave(@ModelAttribute("actor") @Valid final Ranger actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
	...
	//Saving explorer ---------------------------------------------------------------------
	@RequestMapping(value = "/register-explorer", method = RequestMethod.POST, params = {
		"save", "confirmPassword"
	})
	public ModelAndView registerExplorerSave(@ModelAttribute("actor") @Valid final Explorer actor, final BindingResult binding, @RequestParam("confirmPassword") final String confirmPassword) {
		ModelAndView result;
		Authority auth;
