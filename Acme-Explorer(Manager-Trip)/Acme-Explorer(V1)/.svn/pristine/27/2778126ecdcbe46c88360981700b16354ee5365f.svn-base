...
<form:form action = "note/${role}/edit.do" modelAttribute = "note">
	...
	<input type = "submit" name = "save" class = "btn" value = "<spring:message code = "note.save"/>" />
	...
	<a href="trip/detailed-trip.do?tripId=${note.trip.id}&anonymous=false">
		<input type = "button" class = "btn" name = "cancel" value = "<spring:message code = "note.cancel" />"/>
	</a>
