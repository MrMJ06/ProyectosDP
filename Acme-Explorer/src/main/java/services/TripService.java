...
public class TripService {
	...
	public Trip create() {
		...
		final Collection<Lusit> lusits = new HashSet<Lusit>();
	...
	public Collection<Lusit> findPublicatedLusitsFromTrip(final int tripId) {
		Assert.isTrue(tripId != 0);

		Collection<Lusit> result;

		result = this.tripRepository.findPublicatedLusitsFromTrip(tripId);
	...
	//Requirement 44 
	public Collection<Trip> findTripApplicationSurvival(final SurvivalClass sc) {
		Assert.notNull(sc);
