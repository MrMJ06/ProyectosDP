...
public class ActorService {
	...
	public Actor findOne(final int actorId) {
		...
		result = this.findByActorId(actorId);
		Assert.notNull(result);
	...
	/**
	 * Method to override findOne repository method, due to issue with Spring method
	 * 
	 * @param id
	 *            of the actor to be returned
	 * @return actor with given id
	 */
	public Actor findByActorId(final int id) {
		Actor result;

		result = this.actorRepository.findByActorId(id);
		Assert.notNull(result);
