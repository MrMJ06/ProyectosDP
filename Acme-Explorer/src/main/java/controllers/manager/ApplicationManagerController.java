...
public class ApplicationManagerController extends AbstractController {
	...
	public ModelAndView list() {
		...
		final Collection<Application> aps = this.managerService.findManagedApplicationsByManager(actor);

		if (aps != null)
			applications = this.managerService.findManagedApplicationsByManager(actor);
