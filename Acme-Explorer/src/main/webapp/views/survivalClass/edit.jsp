...
<form:form action = "survivalClass/manager/edit.do" modelAttribute = "survivalClass">
	...
	<input type = "submit" name = "save" class = "btn" value = "<spring:message code = "survivalclass.save"/>" />
	...
	<input type = "button" name = "cancel" class = "btn" value = "<spring:message code = "survivalclass.cancel" />" >
	</a>
